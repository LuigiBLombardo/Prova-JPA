...
-- =============================================================================
INSERT INTO tb_transformador ( numero_serie, modelo, subestacao, potencia_kva, limite_temp_oleo, limite_temp_enrol)
...
-- =============================================================================
INSERT INTO tb_leitura_termica ( transformador_id, temp_oleo, temp_enrolamento, data_hora_leitura)
VALUES (1, 89.00, 110.50, '2026-09-10 12:00:00');

INSERT INTO tb_alerta_termico (transformador_id, leitura_id, data_alerta, tipo, descricao)
